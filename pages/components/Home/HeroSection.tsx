      ...
      <SectionHero>
        ...
        <ProfilImage>
          ...
          <Image
            ...
            height="220"
            width="150"
            className="rounded-2xl shadow-md bg-cdark mt-4"
          />
        </ProfilImage>
        <ProfilDesc>
        ...
        <DescHero>
          ...
          <p className="px-5 italic text-sm text-cwhite">
            Web Programming, Database (MySQL, SQLite, MongoDB), RestFull API,
            Data Science, Data Enggineering, Artifial Intelligence (Machine
